...
max_energy = 0
for i in range(C):
    max_energy = max(max_energy, simulate(0, i, 'south', grid))
for i in range(C):
    max_energy = max(max_energy, simulate(R - 1, i, 'north', grid))
for i in range(R):
    max_energy = max(max_energy, simulate(i, 0, 'east', grid))
for i in range(R):
    max_energy = max(max_energy, simulate(i, C - 1, 'west', grid))
print(max_energy)
