...
import math
charging_time_1 = math.ceil(time/2 - ((time/2)**2 - current_record_distance)**.5)
charging_time_2 = math.floor(time/2 + ((time/2)**2 - current_record_distance)**.5)

print(charging_time_1)
print(charging_time_2)
print(charging_time_2 - charging_time_1 + 1)
